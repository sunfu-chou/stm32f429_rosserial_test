#ifndef _ROS_nlink_parser_LinktrackNode2_h
#define _ROS_nlink_parser_LinktrackNode2_h
...
namespace nlink_parser
{
  ...
  class LinktrackNode2 : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return "nlink_parser/LinktrackNode2"; };
    virtual const char * getMD5() override { return "ebc34feb8e11fb1b06d65ee49880b996"; };
