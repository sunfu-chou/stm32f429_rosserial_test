#ifndef _ROS_nlink_parser_LinktrackNodeframe1_h
#define _ROS_nlink_parser_LinktrackNodeframe1_h
...
namespace nlink_parser
{
  ...
  class LinktrackNodeframe1 : public ros::Msg
  {
    public:
      ...
      typedef nlink_parser::LinktrackNode1 _nodes_type;
    ...
    virtual int deserialize(unsigned char *inbuffer) override
    {
      ...
      if(nodes_lengthT > nodes_length)
        this->nodes = (nlink_parser::LinktrackNode1*)realloc(this->nodes, nodes_lengthT * sizeof(nlink_parser::LinktrackNode1));
      nodes_length = nodes_lengthT;
      for( uint32_t i = 0; i < nodes_length; i++){
      offset += this->st_nodes.deserialize(inbuffer + offset);
        memcpy( &(this->nodes[i]), &(this->st_nodes), sizeof(nlink_parser::LinktrackNode1));
      }
     return offset;
    }

    virtual const char * getType() override { return "nlink_parser/LinktrackNodeframe1"; };
    virtual const char * getMD5() override { return "0a522663cdf935548d202960a37f14ce"; };
