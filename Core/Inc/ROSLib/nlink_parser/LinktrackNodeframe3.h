#ifndef _ROS_nlink_parser_LinktrackNodeframe3_h
#define _ROS_nlink_parser_LinktrackNodeframe3_h
...
namespace nlink_parser
{
  ...
  class LinktrackNodeframe3 : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return "nlink_parser/LinktrackNodeframe3"; };
    virtual const char * getMD5() override { return "d5fe6bc25d71efe36dc5d4595d69025e"; };
