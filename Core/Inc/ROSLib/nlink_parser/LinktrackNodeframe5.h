#ifndef _ROS_nlink_parser_LinktrackNodeframe5_h
#define _ROS_nlink_parser_LinktrackNodeframe5_h
...
namespace nlink_parser
{
  ...
  class LinktrackNodeframe5 : public ros::Msg
  {
    public:
      ...
      typedef nlink_parser::LinktrackNode5 _nodes_type;
    ...
    virtual int deserialize(unsigned char *inbuffer) override
    {
      ...
      if(nodes_lengthT > nodes_length)
        this->nodes = (nlink_parser::LinktrackNode5*)realloc(this->nodes, nodes_lengthT * sizeof(nlink_parser::LinktrackNode5));
      nodes_length = nodes_lengthT;
      for( uint32_t i = 0; i < nodes_length; i++){
      offset += this->st_nodes.deserialize(inbuffer + offset);
        memcpy( &(this->nodes[i]), &(this->st_nodes), sizeof(nlink_parser::LinktrackNode5));
      }
     return offset;
    }

    virtual const char * getType() override { return "nlink_parser/LinktrackNodeframe5"; };
    virtual const char * getMD5() override { return "26bd069cbc20641e42df0ae46b96110c"; };
